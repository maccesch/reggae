# Django settings for suedgame project.
...
DATABASE_NAME = join(PROJECT_PATH, 'db')             # Or path to database file if using sqlite3.
...
SECRET_KEY = '!n^+tb0p-$$m%bnhcm3!-^evd_v=lb1%4d+eg*g0=jg9!n6vzc'
